...
const featured: FeaturedItem[] = [
    ...
    },
    {
        ...
        image: ["/images/featured/welcome-back-party.jpg"],
        imageAlts: ["BDCI Welcome Back Party flyer"],
...
export const Featured = () => {
    ...
    return (
        <section className="featured-section flex w-full justify-center px-6 py-16 sm:px-12 lg:px-16">
            <div className="featured-board relative grid w-full grid-cols-1 items-start justify-items-center gap-x-12 gap-y-8 xl:grid-cols-[auto_auto] xl:justify-items-stretch">
